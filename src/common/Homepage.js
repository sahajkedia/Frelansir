...
<div className="h-screen pb-14 bg-right bg-cover" style={{backgroundImage:`url(${img})`}}>
	...
	<div className="w-full container mx-auto p-6">
		...
		<div className="w-full flex items-center justify-between">
			...
			<div className="flex w-1/2 justify-end content-center">		
				<a className="inline-block  no-underline hover:text-indigo-800 hover:text-underline text-center h-20 p-2 md:h-auto md:p-4" style={{color:'#0d054f', height: '5em'}} >
				...
				<a className="inline-block  no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 " data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
	...
	<div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		...
		<div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
			<h1 className="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Do you want to change your Future?</h1>
			<p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">We have got you covered. Just sign up now and get your work done</p>
		</div>
