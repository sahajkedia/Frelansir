	...
	<div className="w-full container mx-auto p-6">
		...
		<div className="w-full flex items-center justify-between">
			...
			<div className="flex w-1/2 justify-end content-center">		
				<Link className="inline-block  no-underline hover:text-indigo-800 hover:text-underline text-center h-20 p-2 md:h-auto md:p-4" style={{color:'#0d054f', height: '5em'}} to="/frelansir/signin">
